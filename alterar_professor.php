...
if (isset($_GET["numero"])) {
    $dadosProfessor = $Professores->listarID($_GET["numero"]);
}
            ...
            <div class="col-lg-12">
                <form action="alterar_professor.php?numero=<?php echo $dadosProfessor->numero; ?>" method="post">
                    <div class="row">
                        ...
                        <div class="form-group col-lg-3">
                            ...
                            <select name="sexo" class="form-control">
                                <option value="Masculino" <?php if ($dadosProfessor->sexo == "Masculino") {
                                                                echo "selected";
                                                            } ?>>Masculino</option>
                                <option value="Feminino" <?php if ($dadosProfessor->sexo == "Feminino") {
                                                                echo "selected";
                                                            } ?>>Feminino</option>
                                <option value="Outros" <?php if ($dadosProfessor->sexo == "Outros") {
                                                            echo "selected";
                                                        } ?>>Outros</option>
                            </select>
                        </div>
                    ...
                    <div align="center">
                        ...
                        <a class="btn btn-outline-danger" href="index_professores.php">Cancelar</a>
                    </div>
                </form>
            </div>
        </div>
